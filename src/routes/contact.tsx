    ...
    <Layout>
          ...
          <div className="mt-14 grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
            ...
            <Reveal className="space-y-7">
              {details.map((detail, index) => (
                <div
                  key={detail.title}
                  className="card-animate group border border-border bg-card p-6 sm:p-7"
                >
                  <div className="flex items-start gap-5">
                    <div className="flex h-11 w-11 shrink-0 items-center justify-center border border-gold/50 text-gold transition-all duration-300 group-hover:bg-gold group-hover:text-foreground">
                      <detail.Icon
                        size={19}
                        strokeWidth={1.6}
                        aria-hidden="true"
              ...
              {/* ===================================================
                  SOCIAL
              =================================================== */}
              <div className="card-animate border border-border bg-secondary/60 p-7 sm:p-8">
                ...
                <div className="mt-6 flex gap-3">
                  {[
                    ...
                    <a
                      ...
                      className="flex h-11 w-11 items-center justify-center border border-border bg-background text-foreground/75 transition-all duration-300 hover:-translate-y-1 hover:border-gold hover:bg-gold hover:text-foreground"
                    >
                      <Icon size={17} />
                    </a>
                  ))}
            ...
            ===================================================== */}
            <Reveal delay={120}>
              <div className="card-animate border border-border bg-card p-6 shadow-sm sm:p-8 lg:p-10">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            {contactHelp.map((item, index) => (
              <Reveal
                key={item.title}
                delay={index * 90}
                className="card-animate group border border-border bg-background p-7 sm:p-8"
              >
          ...
          <Reveal className="mt-14">
            <div className="card-animate overflow-hidden border border-border">
              <div className="grid lg:grid-cols-[0.8fr_1.2fr]">
                {/* LOCATION INFO */}
                <div className="flex flex-col justify-center bg-foreground p-8 text-background sm:p-10 lg:p-12">
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-gold">
                    SAVORA Restaurant
                  </p>

                  <h2 className="mt-4 font-display text-3xl font-semibold text-background sm:text-4xl">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="mt-8 inline-flex w-fit items-center gap-2 border border-background/30 px-5 py-3 text-sm font-semibold text-background transition-all duration-300 hover:translate-x-1 hover:border-gold hover:bg-gold hover:text-foreground"
                  >
                    Open in Google Maps
                    <ArrowRight size={15} />
                  </a>
                ...
                <iframe
                  ...
                  className="h-[340px] w-full sm:h-[430px] lg:h-full lg:min-h-[500px]"
                  loading="lazy"
                />
              </div>
            </div>
      ...
      <section className="relative overflow-hidden bg-foreground py-20 sm:py-28">
        ...
        <div className="relative mx-auto max-w-4xl px-5 text-center sm:px-8">
          ...
          <h2 className="mt-5 font-display text-4xl font-semibold leading-tight text-background sm:text-5xl lg:text-6xl">
            We look forward to hearing from you.
          </h2>

          <p className="mx-auto mt-6 max-w-2xl text-sm leading-relaxed text-background/85 sm:text-base">
          ...
          <a
            href="/reservations"
            className="mt-9 inline-flex items-center gap-3 border border-background/40 px-7 py-3.5 text-sm font-semibold text-background transition-all duration-300 hover:-translate-y-1 hover:border-gold hover:bg-gold hover:text-foreground"
          >
            Reserve Your Table
            <ArrowRight size={16} />
          </a>
