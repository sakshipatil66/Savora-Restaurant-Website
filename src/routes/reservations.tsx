              ...
              <div className="card-animate border border-border bg-card p-6 shadow-sm sm:p-8 lg:p-10">
                <div className="mb-8 border-b border-border pb-6">
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-foreground/75">
                    Complete the details below and we will
            ...
            <Reveal delay={120} className="space-y-6">
              ...
              <div className="card-animate border border-border bg-secondary/60 p-7 sm:p-8">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-foreground transition-all duration-300 hover:translate-x-1 hover:text-gold"
                >
                  Open in Google Maps
                  <ArrowRight size={15} />
                </a>
              ...
              {/* GOOD TO KNOW */}
              <div className="card-animate bg-foreground p-7 text-background sm:p-8">
                <p className="text-xs font-semibold uppercase tracking-[0.18em] text-gold">
                  Good to Know
                </p>

                <h2 className="mt-3 font-display text-2xl font-semibold text-background">
                  Planning a larger gathering?
                </h2>

                <p className="mt-4 text-sm leading-relaxed text-background/85">
                  Parties of eight or more are served a set
                  menu. For private dining and special occasions,
                  our team can create a more tailored experience.
                </p>

                <a
                  href="/experience"
                  className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-background transition-all duration-300 hover:translate-x-1 hover:text-gold"
                >
      ...
      <section className="bg-background py-20 sm:py-28">
        <div className="mx-auto grid max-w-7xl gap-10 px-5 sm:px-8 lg:grid-cols-2 lg:gap-16">
          ...
          <Reveal>
            ...
            <div className="mt-7 space-y-6 text-sm leading-relaxed text-foreground/75 sm:text-base">
              <div className="card-animate border-l-2 border-gold/40 pl-5">
